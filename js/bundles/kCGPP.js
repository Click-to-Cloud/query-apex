...
var kCGPP = function (_Component) {
  _inherits(kCGPP, _Component);

  function kCGPP() {
    _classCallCheck(this, kCGPP);

    return _possibleConstructorReturn(this, (kCGPP.__proto__ || Object.getPrototypeOf(kCGPP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kCGPP, _step_11Soy2.default);

exports.default = kCGPP;
...
exports.templates = exports.kCGPP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kCGPP.
   * @public
   */

  goog.module('kCGPP.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param874 = function param874() {
      ie_open('h2');
      var dyn36 = opt_data.page.title;
      if (typeof dyn36 == 'function') dyn36();else if (dyn36 != null) itext(dyn36);
      ie_close('h2');
      ie_open('p');
      itext('With HAVING clauses, aggregate functions can be even more powerful. See this example:');
      ie_close('p');
      ie_open('p');
      ...
      ie_close('p');
      ie_open('p');
      itext('But we can actually do it in one query, using GROUP BY and HAVING clauses.');
      ie_close('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kCGPP.render';
  }
...
_metalSoy2.default.register(kCGPP, templates);
exports.kCGPP = kCGPP;
