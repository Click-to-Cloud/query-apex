...
var tDLVX = function (_Component) {
  _inherits(tDLVX, _Component);

  function tDLVX() {
    _classCallCheck(this, tDLVX);

    return _possibleConstructorReturn(this, (tDLVX.__proto__ || Object.getPrototypeOf(tDLVX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tDLVX, _fieldSoy2.default);

exports.default = tDLVX;
...
exports.templates = exports.tDLVX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tDLVX.
   * @public
   */

  goog.module('tDLVX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tDLVX.render';
  }
...
_metalSoy2.default.register(tDLVX, templates);
exports.tDLVX = tDLVX;
